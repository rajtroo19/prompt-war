...
export default function DashboardPage() {
  ...
  const daysUntilExam = profile?.examDate
    ? getDaysUntilExam(profile.examDate)
    : null;
  ...
  const quickCards = [
    {
      ...
      icon: SmilePlus,
      label: 'Check-in',
      desc: todayEntry ? 'Done today ✓' : 'Log your mood',
      color: '#6EE7B7',
    },
    {
      href: '/journal',
    ...
    <div className="page-container">
      ...
      >
        ...
        >
          <Flame
            size={28}
            style={{ color: streak > 0 ? '#FCD34D' : '#64748B', marginBottom: '0.5rem' }}
          />
          <div
            style={{
              fontFamily: 'var(--font-heading)',
          ...
          {todayEntry ? (
            <>
              <div style={{ fontSize: '2rem', marginBottom: '0.25rem' }}>
                {MOOD_CONFIG[todayEntry.mood - 1]?.emoji}
              </div>
              <div
                style={{
                  fontFamily: 'var(--font-heading)',
                  fontSize: '1.2rem',
                  fontWeight: 700,
                  color: MOOD_CONFIG[todayEntry.mood - 1]?.color,
                }}
              >
                {MOOD_CONFIG[todayEntry.mood - 1]?.label}
              </div>
              <div style={{ color: '#94A3B8', fontSize: '0.85rem' }}>
                Today&apos;s Mood
              </div>
            ...
            >
              <SmilePlus size={28} style={{ color: '#6EE7B7' }} />
        ...
        >
          <Trophy
            size={28}
            style={{
              color: profile.badges.length > 0 ? '#6EE7B7' : '#64748B',
              marginBottom: '0.5rem',
            }}
          />
          <div
        ...
        {daysUntilExam !== null && (
          ...
          >
            <Calendar
              size={28}
              style={{ color: '#818CF8', marginBottom: '0.5rem' }}
            />
            <div
              style={{
                fontFamily: 'var(--font-heading)',
