...
export function WellnessCoach() {
  ...
  const buildMoodContext = () => {
    ...
    const summary = recentEntries
      .map(
        (e) =>
          `${e.date}: mood ${e.mood}/5${
            e.stressTriggers.length > 0
              ? `, triggers: ${e.stressTriggers.join(', ')}`
              : ''
          }`
      )
      .join('; ');
  ...
  const sendMessage = async (content: string) => {
    ...
    try {
      ...
      const errorAssistant = saveChatMessage(
        'assistant',
        "I'm having trouble connecting right now. Please try again in a moment. Remember, you're doing great — take a deep breath. 🤗"
      );
      ...
      >
          ...
          >
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#94A3B8', fontSize: '0.9rem', maxWidth: '400px' }}>
                I understand the pressure of exam prep. Share what&apos;s on your
                mind — I&apos;m here to listen and help.
              </p>
            </div>
        ...
        {isLoading && (
          <motion.div
            ...
            style={{ display: 'flex', gap: '0.375rem', padding: '1rem 1.25rem' }}
          >
